...
! function(a, b) {
    ...
    var id = "Ocak_Şubat_Mart_Nisan_Mayıs_Haziran_Temmuz_Ağustos_Eylül_Ekim_Kasım_Aralık".split("_"),
        jd = "Ock_Şub_Mar_Nis_May_Haz_Tem_Ağus_Eyl_Eki_Kas_Ara".split("_"),
        kd = {};
    ...
    var Ad = "Pazar_Pazartesi_Salı_Çarşamba_Perşembe_Cuma_Cumartesi".split("_"),
        Bd = "Pzr_Pzt_Sal_Çrş_Perş_Cum_Cmt".split("_"),
        Cd = "Pz_Pt_Sl_Çş_Pr_Cm_Ct".split("_");
